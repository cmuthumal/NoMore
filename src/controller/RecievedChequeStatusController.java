...
import db.RecievedChequeStatusDBAccess;
 ...
 */
public class RecievedChequeStatusController {

    private RecievedChequeStatusDBAccess chequeStatusDBAccess;

    public RecievedChequeStatusController() {
        chequeStatusDBAccess = new RecievedChequeStatusDBAccess();
    }
